-- Donovan Database Schema (MySQL)
-- Run this SQL script to create the initial database structure

-- Users table (linked to Auth0)
CREATE TABLE IF NOT EXISTS users (
  id INT AUTO_INCREMENT PRIMARY KEY,
  auth0_id VARCHAR(255) UNIQUE NOT NULL,  -- Auth0 user.sub (unique identifier)
